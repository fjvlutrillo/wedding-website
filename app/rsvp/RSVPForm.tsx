                    ...
                    <div className="bg-gradient-to-br from-wedding-burgundy to-wedding-burgundy-light p-8 sm:p-12 text-center relative overflow-hidden">
                        ...
                        <div className="relative space-y-4">
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-light text-white leading-tight">
                                Confirma tu
                                <span className="block font-luxury text-5xl sm:text-6xl md:text-7xl mt-2">
                                    Asistencia
                                </span>
                            </h1>
                    ...
                    <div className="p-8 sm:p-12">
                        ...
                        {status === 'loading' && (
                            <div className="text-center py-12 space-y-4">
                                ...
                                <p className="text-stone-600 font-light">Cargando...</p>
                            </div>
                        )}
                        ...
                        {status === 'error' && (
                            <div className="text-center py-12 space-y-6">
                                ...
                                <div className="space-y-2">
                                    <h2 className="text-2xl font-light text-wedding-burgundy">Invitación no válida</h2>
                                    <p className="text-stone-600 leading-relaxed">
                                        El enlace de invitación no es válido o ha expirado.
                                        <br />
                                        Por favor, contacta a los novios.
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        {status === 'already' && (
                            <div className="text-center py-12 space-y-6">
                                ...
                                <div className="space-y-3">
                                    <h2 className="text-3xl font-light text-wedding-burgundy">¡Gracias, {guestName}!</h2>
                            ...
                            <div className="space-y-8 py-6">
                                ...
                                <div className="text-center space-y-3">
                                    <h2 className="text-3xl sm:text-4xl font-light text-wedding-burgundy">
                                        Hola, <span className="font-luxury text-4xl sm:text-5xl">{guestName}</span>
                                    </h2>
                                ...
                                <div className="max-w-md mx-auto space-y-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-xs text-stone-500">
                                            Máximo {maxGuests} {maxGuests === 1 ? 'persona' : 'personas'} según tu invitación
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <label htmlFor="dietaryRestrictions" className="block text-sm font-medium text-wedding-burgundy uppercase tracking-wider">
                                            Restricciones alimentarias <span className="text-stone-400 normal-case text-xs">(Opcional)</span>
                                        </label>
                                        <textarea
