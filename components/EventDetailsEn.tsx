...
import HotelCardsEN from '@/components/HotelCardsEN'
...
export default function EventDetailsEN() {
    ...
    const events: Record<'ceremony' | 'reception', Event> = {
        ceremony: {
            ...
            description: 'The religious ceremony will take place in the hacienda chapel. Begins at 1:00PM'
        },
        reception: {
            title: 'Reception',
            time: '3:00 PM',
            ...
            description: 'After the ceremony, we hope you will join us to celebrate in the hacienda gardens.'
    }
    }
    ...
    return (
        <section id="event" className="relative py-24 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <SectionHeader
                    ...
                    title="The"
                    subtitle="Event"
                    description="June 6, 2026 · Puebla, Mexico"
                    align="center"
                />
