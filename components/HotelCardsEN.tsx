...
export default function HotelCardsEN() {
    const hotels: Hotel[] = [
        {
            name: "CASAREYNA",
    ...
    return (
        <div className="space-y-12">
            ...
            {/* Host Hotel - Featured large card (CASAREYNA - PHONE ONLY) */}
                            ...
                            <div className="p-8 sm:p-10 flex flex-col justify-between">
                                <div className="space-y-6">
                                    ...
                                    <div className="space-y-2 pt-4 border-t border-wedding-blush">
                                        <p className="text-sm text-stone-600">
                                            <span className="font-medium text-wedding-burgundy">Reservation code:</span> {hostHotel.reservationInfo.code}
                                        </p>
                                        <p className="text-sm text-stone-600">
                                            <span className="font-medium text-wedding-burgundy">Phone number:</span> {hostHotel.reservationInfo.phone}
                                        </p>
                                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 mt-3">
                                            <p className="text-xs text-amber-800">
                                                <span className="font-medium">Important:</span> To receive the special rate, please contact the hotel directly.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-3 mt-6">
                                    <a
                                        ...
                                        className="w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-wedding-burgundy hover:bg-wedding-burgundy-light text-white text-sm tracking-wide uppercase transition-all duration-300 rounded-full shadow-wedding-lg hover:shadow-xl hover:-translate-y-0.5"
                                    >
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                {supportHotels.map((hotel, idx) => {
                    // Determine button type based on reservation method
                            ...
                            <div className="p-6 sm:p-8 space-y-4">
                                ...
                                <div className="flex flex-col gap-2 pt-2">
                                    {method === 'email-whatsapp' ? (
                                        // BANYAN TREE: Email and WhatsApp buttons
                                        <>
                                            <a
                                                href={`mailto:${hotel.reservationInfo.email}?subject=${encodeURIComponent(`Booking code ${hotel.reservationInfo.code}`)}`}
                                            ...
                                            <a
                                                href={`https://wa.me/${hotel.reservationInfo.whatsapp}?text=${encodeURIComponent(`Hi, I would like to book a room using the reservation code. ${hotel.reservationInfo.code}`)}`}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                        ...
                                        // CITY EXPRESS: Email (with CCs) and Phone buttons
                                        <>
                                            <a
                                                href={`mailto:${hotel.reservationInfo.email}?cc=${hotel.reservationInfo.emailCC?.join(',')}&subject=${encodeURIComponent(`Booking - Code ${hotel.reservationInfo.code}`)}`}
                                                className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-wedding-burgundy hover:bg-wedding-burgundy-light text-white text-xs tracking-wider uppercase transition-all duration-300 rounded-full shadow-wedding-lg hover:shadow-xl hover:-translate-y-0.5"
                                            >
                                                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                        ...
                                        // DEFAULT: Online and Phone buttons
                                        <>
                                            <a
                                                href={hotel.reservationInfo.website}
                                                target="_blank"
                ...
                <div className="bg-gradient-to-br from-amber-50 to-white rounded-2xl p-6 border border-amber-200/50 shadow-wedding">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 space-y-2">
                            <h4 className="text-base font-medium text-wedding-burgundy">Important Info</h4>
