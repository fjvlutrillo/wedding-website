  ...
  const dressCodeOptions: DressCodeOption[] = [
    {
      ...
      examples: ['Traje de 2 o 3 piezas', 'Corbata', 'NO TENIS'],
    ...
    <section className="relative py-16 sm:py-20 px-4 bg-gradient-to-b from-white to-stone-50">
      <div className="max-w-6xl mx-auto">
        ...
        <SectionHeader
          ...
          title="Código de"
          subtitle="Vestimenta"
          description="Queremos que te sientas cómodo y elegante en nuestra celebración"
          align="center"
        />
          ...
          <div className="bg-gradient-to-br from-amber-50 to-white rounded-2xl p-8 border border-amber-200/50 shadow-wedding">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h4 className="text-lg font-light text-wedding-burgundy mb-2">Nota importante</h4>
